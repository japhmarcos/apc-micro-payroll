...
class DeductionsController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','dynamicEarnings'),
				'users'=>array('@'),
			),
	...
	public function actionDynamicEarnings()
	{
		$data=earnings::model()->findAll('employee_id=:employee_id',
		array(':employee_id'=>(int) $_POST['deductions']['employee_id']));
		$data=CHtml::listData($data,'id', 'EarningsInfo');
